...
test.describe('Workitu Tech Website', () => {
  test('should load home page', async ({ page }) => {
    await page.goto('https://workitu-tech-website-mf6zt0yff-yonatan-perlins-projects.vercel.app');
  ...
  test('should access admin panel without login', async ({ page }) => {
    await page.goto('https://workitu-tech-website-mf6zt0yff-yonatan-perlins-projects.vercel.app/admin');
    // Should be able to access admin without authentication
    await expect(page.locator('h1')).toContainText(/Admin/);
  });

  test('should have working contact form', async ({ page }) => {
    await page.goto('https://workitu-tech-website-mf6zt0yff-yonatan-perlins-projects.vercel.app/contact');
