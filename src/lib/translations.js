export const translations = {
  en: {
    ...
    contact: {
      ...
      description: 'Ready to turn your vision into reality? Get in touch with us to discuss your project, ask questions, or just say hello. We\'re here to help you succeed.',
  ...
  he: {
    ...
    home: {
      title: 'וורקיטו טק',
      tagline: 'כאשר דמיון פוגש חדשנות',
    ...
    pricing: {
      ...
      services: {
        website: {
          title: '🌐 בניית אתרים',
          price: 'החל מ-$320',
          description: 'אתרים אלגנטיים, מהירים ומותאמים למובייל שנועדו להרשים ולהניב תוצאות. מושלם למותגים אישיים, סטארטאפים ועסקים קטנים מוכנים לצמוח.'
        },
        ecommerce: {
          title: '🛒 פתרונות מסחר אלקטרוני',
          price: 'החל מ-$950',
          description: 'חנויות מקוונות חזקות ומאובטחות שעוזרות לכם למכור בביטחון ובסטייל. כולל אינטגרציית תשלומים, ניהול מלאי והקמת שיווק דיגיטלי.'
        },
        ai: {
          title: '🤖 אפליקציות מונעות AI',
          price: 'החל מ-$670',
          description: 'הפכו את הרעיונות שלכם לתוכנה חכמה וניתנת להרחבה המונעת על ידי בינה מלאכותית יוצרת. אנחנו מאטמים תהליכי עבודה, מתאימים אישית חוויות וגורמים ל-AI לעבוד בשבילכם.'
        },
        marketing: {
          title: '📈 שיווק דיגיטלי וצמיחה',
          price: 'החל מ-$270/חודש',
          description: 'אנחנו מגדילים את הנוכחות המקוונת שלכם עם SEO, אוטומציה ואסטרטגיית רשתות חברתיות. מחיפוש ועד סיפור סיפורים — המותג שלכם ראוי להיראות ולהיזכר.'
        },
        custom: {
          title: '⚙️ פרויקטים מותאמים אישית',
          price: 'כל רעיון ייחודי — וכך גם כל מחיר.',
          description: 'בואו נדון בחזון שלכם, נגדיר את המטרות ונעצב יחד את הפתרון המושלם.'
        }
      }
    },
    ...
    contact: {
      ...
      description: 'מוכנים להפוך את החזון שלכם למציאות? צרו איתנו קשר כדי לדון בפרויקט שלכם, לשאול שאלות או פשוט להגיד שלום. אנחנו כאן לעזור לכם להצליח.',
      ...
      emailPlaceholder: 'your.email@example.com',
      message: 'הודעה',
      messagePlaceholder: 'ספרו לנו על הפרויקט שלכם או שאלו אותנו כל דבר...',
      send: 'שלח הודעה',
      sending: 'שולח...',
      infoTitle: 'צרו קשר',
      emailLabel: 'אימייל',
