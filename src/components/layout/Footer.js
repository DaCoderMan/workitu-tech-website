...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 bg-black/90 border-t border-gold-500/20 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link href="/legal" className="block text-gold-300 hover:text-gold-400 text-sm transition-colors">
                {t('footer.legal')}
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-green-400 hover:text-green-300 text-sm font-semibold transition-colors mt-1"
              >
