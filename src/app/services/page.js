...
export default function Services() {
  ...
  const process = [
    ...
    { step: '03', title: 'Design', description: 'We design the user interface and user experience.' },
    { step: '04', title: 'Development', description: 'We build your solution with clean, maintainable code.' },
    { step: '05', title: 'Testing', description: 'We thoroughly test everything before launch.' },
    { step: '06', title: 'Launch & Support', description: 'We deploy and provide ongoing support.' },
  ];
  ...
  return (
    <div className="relative min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="glass rounded-xl p-8 card-hover fade-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="text-gold-400 mb-6">{service.icon}</div>
                <h3 className="text-2xl font-bold text-gold-300 mb-4">{service.title}</h3>
                <p className="text-gold-400/70 mb-6">{service.description}</p>
      ...
      <section className="relative z-10 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-gold-400 mb-12 text-center fade-in">Our Process</h2>
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6">
            {process.map((step, index) => (
              <div
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="text-4xl font-bold text-gold-400/30 mb-2">{step.step}</div>
      ...
      <section className="relative z-10 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center glass rounded-xl p-12 fade-in">
          <h2 className="text-3xl font-bold text-gold-400 mb-4">Ready to Get Started?</h2>
          <p className="text-gold-300/80 mb-8">
            Check out our pricing or contact us for a custom quote.
          </p>
